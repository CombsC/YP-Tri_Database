...
namespace YPTriMembership.Controllers
{
    public class SponsorsController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(Sponsor e)
        {
            var SponsorId = _db.Sponsors.Where(i => i.Sponsor_id.Equals(e.Sponsor_id)).FirstOrDefault();
            _db.Sponsors.Remove(SponsorId);
            _db.SaveChanges();
            return RedirectToAction("Index");
        }//end DeleteConfirmed
    }
